...
export default [
  {
    ...
    routes: [
      ...
      { path: '/teacher/homework/completion/detail', component: './teacherHomeworkDetail' },
      {
        path: '/teacher/homework/completion/detail/edit',
        component: './teacherHomeworkDetailEdit',
      },
      { path: '/teacher/userInfo', component: './teacherInfo' },
      { path: '/teacher/passwordEdit', component: './passwordEdit' },
